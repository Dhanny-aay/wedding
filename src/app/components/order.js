...
const Order = () => {
  ...
  return (
    <div className="bg-primary py-[130px] px-4 md:px-12 lg:px-40 w-full flex items-center flex-col justify-center">
      <p className="mt-11 text-[#FFFFFF] font-normal text-sm leading-1 tracking-[5px] uppercase">
        HikmaT & Noah
      </p>
      <h2 className="mt-4 font-alexBrush text-[#fff] text-[60px] leading-[60px] font-normal mb-16">
        Order of Event
      </h2>
      ...
      <div className="relative max-w-4xl w-full">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 w-[3px] bg-[#E8EFED] h-full"></div>
        ...
        <div className="space-y-8 pt-8 pb-8">
          {events.map((event, index) => (
            <div key={index} className="relative flex items-center">
              {/* Timeline Dot */}
              <div className="absolute left-1/2 transform -translate-x-1/2  bg-white w-[60px] h-[60px] flex items-center justify-center rounded-full border-2 border-[#D9ECE7] z-10">
